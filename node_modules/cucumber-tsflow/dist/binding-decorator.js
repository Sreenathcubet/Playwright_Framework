(function (factory) {
    ...
    function ensureNoCyclicDependencies(target, currentPath = []) {
        const dependencies = binding_registry_1.BindingRegistry.instance.getContextTypesForTarget(target.prototype);
        if (dependencies.length === 0) {
            return;
        }
        for (const dependency of dependencies) {
            if (dependency === undefined) {
                throw new Error(`Undefined dependency detected in ${target.name}. You possibly have an import cycle.\n` +
    ...
    function bindHook(stepBinding) {
        ...
        const bindingOptions = {
            timeout: stepBinding.timeout,
            tags: stepBinding.tag === binding_registry_1.DEFAULT_TAG ? undefined : stepBinding.tag,
            ...((_a = stepBinding.hookOptions) !== null && _a !== void 0 ? _a : {}),
        };
        ...
        switch (stepBinding.bindingType) {
            ...
            case step_binding_1.StepBindingFlags.beforeStep:
                (0, cucumber_1.BeforeStep)(bindingFunc);
                break;
            case step_binding_1.StepBindingFlags.afterStep:
                (0, cucumber_1.AfterStep)(bindingFunc);
                break;
